...
router.post("/downloadPdf", AuthToken, async (req, res) => {
  ...
  try {
    ...
    const reportIcon = path.join(
      __dirname,
      "../../Front/img/report_modified.png"
    );
    ...
    doc
      ...
      .fillColor("black")
      .text(
        `생년월일 : ${birthdate}   성별 : ${gender}   키: ${height}   몸무게: ${weight}`,
        { align: "center" }
      );
    doc.moveDown();
    ...
    doc
      .fontSize(14)
      .fillColor("black")
      .text(`검사 일시: ${analysisDate}`, { align: "center" });
    doc.moveDown(1);
